...
<body class="body body" background-image="winter.jpg">
...
<div id="container">
 <div id="body">
   ...
   <?php if($editData){
     $id = $editData->nim_mahasiswa;
     $nim = $editData->nim_mahasiswa;
     $nama = $editData->nama;
   ...
   <form action="<?php echo site_url('welcome/update/'.$id) ?>" method="post">
      ...
      <button class="button buttona" type="submit" name="save" value="save" />Simpan</button>
    </form>
